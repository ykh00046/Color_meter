...
def custom_visualizer():
    ...
    config = VisualizerConfig(
        ...
        zone_color_ng=(0, 0, 200),
        zone_label_font_scale=0.8
    )
...
def test_visualize_zone_overlay_ok(visualizer, sample_image, sample_lens_detection, sample_zones, sample_inspection_result):
...
def test_visualize_zone_overlay_ng(visualizer, sample_image, sample_lens_detection, sample_zones, sample_ng_inspection_result):
...
def test_visualize_zone_overlay_no_result_banner(visualizer, sample_image, sample_lens_detection, sample_zones, sample_inspection_result):
...
def test_visualize_zone_overlay_custom_config(custom_visualizer, sample_image, sample_lens_detection, sample_zones, sample_inspection_result):

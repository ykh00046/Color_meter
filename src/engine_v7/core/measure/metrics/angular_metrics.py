...
def calculate_angular_uniformity(state_id_map: np.ndarray, cluster_id: int, *, polar_order: str = "AUTO") -> float:
    """
...
def calculate_angular_coverage(state_id_map: np.ndarray, cluster_id: int, *, polar_order: str = "AUTO") -> float:
    """
...
def build_angular_features(
    state_id_map: np.ndarray, cluster_id: int, r_bins: int = 10, *, polar_order: str = "AUTO"
) -> Dict[str, float]:
    """

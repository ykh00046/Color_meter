...
class LensGeometry:
    ...
    source: str = "hough"
    # P2-1: Separate confidence metrics for debugging
    center_confidence: float = 1.0  # How confident in (cx, cy) position
    radius_confidence: float = 1.0  # How confident in radius value
    center_offset_ratio: float = 0.0  # Distance from image center / image_size

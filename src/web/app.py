...
async def inspect_image(
    ...
    # 6. Run 2D zone analysis (optional, forced to True for now)
    debug_info_2d = None
    use_2d_analysis = True  # Force enable for testing
    image_id = None
...
async def recompute_analysis(
    ...
    async with cache_lock:
        ...
        img_bgr = image_cache[image_id].copy()
